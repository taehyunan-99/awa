...
# 정상 정리 (marker 있음)
SESSION_OVERRIDE="$SESSION_OVERRIDE" bash "$HARNESS_BIN/awa-down.sh"
...
SESSION_OVERRIDE="td_test_$$" bash "$HARNESS_BIN/awa-down.sh"
...
SESSION_OVERRIDE="td_nomark_$$" bash "$HARNESS_BIN/awa-down.sh" >/dev/null 2>&1
