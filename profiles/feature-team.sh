...
WORKERS=("dev:dev" "test:tester" "arch:researcher")
REVIEWERS=("spec-rev:reviewer-spec" "quality-rev:reviewer-quality" "arch-rev:reviewer-arch" "review-mgr:review-manager")
